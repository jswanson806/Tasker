...
VALUES
  ('Gardening', 'Need help with gardening tasks', 'posted', '123 Main St', 4, NULL, NULL, NULL, NULL, '', ''),
  ('House Cleaning', 'Cleaning required for a 3-bedroom house', 'accepted', '456 Elm St', 1, 3, '2023-06-01 09:00:00', NULL, NULL, '', ''),
  ('Painting', 'Interior painting for a small apartment', 'complete', '789 Oak St', 7, 3, '2023-06-02 10:00:00', '2023-06-02 15:00:00', 125, '', ''),
  ('Dog Walking', 'Need someone to walk my dog twice a day', 'posted', '321 Maple Ave', 10, NULL, NULL, NULL, NULL, '', ''),
  ...
  ('Plumbing Repair', 'Fix a leaky faucet in the kitchen', 'accepted', '567 Walnut St', 1, 3, '2023-06-04 11:00:00', '2023-06-04 12:30:00', NULL, '', ''),
  ('Lawn Mowing', 'Mow the lawn and trim the hedges', 'complete', '234 Oakwood Dr', 5, 6, '2023-06-05 09:00:00', '2023-06-05 11:00:00', 50, '', ''),
  ('House Painting', 'Exterior painting for a two-story house', 'accepted', '456 Birch Ln', 12, 11, '2023-06-06 08:00:00', NULL, NULL, '', ''),
  ('Electrical Repair', 'Fix a faulty electrical outlet in the living room', 'posted', '789 Cedar Rd', 4, NULL, NULL, NULL, NULL, '', ''),
  ...
  ('Carpet Cleaning', 'Deep cleaning for carpets in a large office space', 'posted', '567 Willow Way', 10, NULL, NULL, NULL, NULL, '', ''),
  ('Appliance Installation', 'Install a new dishwasher in the kitchen', 'accepted', '890 Pinecone Rd', 7, 11, '2023-06-08 13:00:00', NULL, NULL, '', '');
